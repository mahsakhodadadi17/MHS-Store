...
MHS Store یک فروشگاه اینترنتی مدرن است که با استفاده از فریم‌ورک **Django** و **Django REST Framework (DRF)** توسعه داده شده است.
...
این پروژه شامل بخش کاربری، پنل مدیریت اختصاصی، API و امکانات متنوع فروشگاهی می‌باشد.
